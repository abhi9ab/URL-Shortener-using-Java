...
@SpringBootApplication(scanBasePackages = "com.shortenurl")
@EntityScan("com.shortenurl")
@ComponentScan("com.shortenurl")
...
public class URLShortenerApplication {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan("com.shortenurl");
